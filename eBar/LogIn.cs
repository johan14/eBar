...
namespace eBar
{
    public partial class LogIn : Form
    {
        ...
        private void logButton_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand getRolID = new SqlCommand("SELECT id, role_id FROM [user] WHERE user_name = @username AND password = @password ",sqlconn);
            ...
            sqlconn.Open();
                ...
                if (dr.Read())
                {
                    UserInformation.CurrentLoggedInUser = dr["id"].ToString();
